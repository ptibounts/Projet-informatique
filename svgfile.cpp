...
void Svgfile::addDisk(int x, int y, double r, std::string color)
{
    m_ostrm << "<circle "
            << attrib("cx", x)
            << attrib("cy", y)
...
void Svgfile::addDisk(double x, double y, double r, std::string color, double thickness, std::string colorStroke)
{
    m_ostrm << "<circle "
            << attrib("cx", x)
            << attrib("cy", y)
...
void Svgfile::addRect(int x, int y, int w, int h, std::string color)
{
    m_ostrm << "<rect "
            << attrib("x", x)
            << attrib("y", y)
...
void Svgfile::addEllipse(int x, int y, int w, int h, std::string color)
{
    m_ostrm << "<ellipse "
            << attrib("cx", x)
            << attrib("cy", y)
